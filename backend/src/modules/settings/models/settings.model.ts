...
const settingsSchema = new Schema<ISettings>(
  {
    ...
    ai: {
      defaultMode: { type: String, enum: ["study", "assistant", "hybrid"], default: "hybrid" },
      responseLength: { type: String, enum: ["short", "balanced", "detailed"], default: "balanced" },
      citations: { type: Boolean, default: true },
      deepReasoning: { type: Boolean, default: true },
    },
    appearance: {
      theme: { type: String, enum: ["arctic", "midnight", "forest", "sunset", "carbon"], default: "arctic" },
...
export default (mongoose.models.Settings as mongoose.Model<ISettings> | undefined) ?? mongoose.model<ISettings>("Settings", settingsSchema);
