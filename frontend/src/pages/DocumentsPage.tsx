...
export default function DocumentsPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-7xl space-y-8">
      ...
      <section className="flex flex-col gap-4 rounded-3xl border border-white/10 bg-white/[0.04] p-5 xl:flex-row">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="h-12 w-full rounded-2xl border border-white/10 bg-white/[0.04] pl-11 pr-4 text-white outline-none transition focus:border-cyan-500"
          />
        ...
        <div className="flex gap-4">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="h-12 rounded-2xl border border-white/10 bg-[#101319] pl-10 pr-8 text-white outline-none"
            >
              <option value="all">
                All
              </option>
      ...
      {!isLoading && isError && (
        ...
        <div className="rounded-3xl border border-red-500/20 bg-red-500/10 p-16 text-center">
      ...
      {!isLoading &&
        ...
        documents.length === 0 && (
          ...
          <div className="rounded-3xl border border-dashed border-white/10 bg-white/[0.03] p-16 text-center">
